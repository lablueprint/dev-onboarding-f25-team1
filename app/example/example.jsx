      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          <Text style={styles.step}>
            1. Create a new folder inside the /app directory with the name for your page.
          </Text>
          <Text style={styles.step}>
            2. Inside that folder, create a new .jsx file. This file will contain your page
            component.
          </Text>
          <Text style={styles.step}>
            3. Build your page using React Native components such as ScrollView, View, Text, Image,
            and Button.
          </Text>
          <Text style={styles.step}>
            4. Style your components using StyleSheet.create() for organized and reusable styles.
          </Text>
          <Text style={styles.step}>
            5. To add a bottom tab bar, add it to the _layout.jsx file.
          </Text>
          <Text style={styles.step}>
            6. Use the useRouter hook from expo-router to navigate between pages programmatically.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.step}>
            1. Start the backend server by cd-ing into the backend (cd backend)
          </Text>
          <Text style={styles.step}>2. Run nodemon server.js to start the development server</Text>
          <Button title="Get Example Post" onPress={() => getExample()} />
          {example && (
